...
# line_bot_api = LineBotApi('ejpDWb5Xfj2jpSAgjioC//96lR+V2ia/08mp/PZp2YBa+Kth4Op2mpcvs9tbyBj21w1p7qHlnJGDWvP0V/7y29ahipQOLd+JiRDdlJq3a2nGrXEIxWgVFSqdsCTi2NqKDeUli49yMH+NBbvHlDGdkQdB04t89/1O/w1cDnyilFU=')
# # 必須放上自己的Channel Secret
# handler = WebhookHandler('231a2bbf041ab4324a87418e287e7abd')
# yourid='Uc22e7ca19197b54da71ae1d6f59a1a04'
...
#####################################系統功能按鈕##############################
   ...
   if re.match('[0-9]{4}[<>][0-9]',usespeak): # 先判斷是否是使用者要用來存股票的
       ...
       return 0
   elif re.match('你好',usespeak): # 刪除存在資料庫裡面的股票
       line_bot_api.push_message(uid, TextSendMessage('安安，你好啊'))
       return 0
